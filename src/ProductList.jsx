...
function ProductList() {
    ...
    useEffect(() => {
        ...
        cart.forEach(item => {
          newAddedToCart[item.name] = true; // Mark items in the cart as added
        });
        ...
        <div>
            ...
            {!showCart ? (<div className="product-grid">
                {plantsArray.map((category, index) => (
                    <div key={index}>
                        <h1><div className='product-category-title'>{category.category}</div></h1>
            ...
            </div>) : (<CartItem onContinueShopping={handleContinueShopping} />)}
    </div>
    );
}
